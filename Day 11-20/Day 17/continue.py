...
# mit exit() wird das ganze script geschlossen mit break brechen wir "nur" aus dem while loop aus
# mit continue beginnen wir den loop erneut und skippen den rest des loops sozusagen
        ...
        if player1_lives == 0:
            ...
            continue
        print("ich werde nicht geprintet wegen coninue")
